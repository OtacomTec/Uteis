<%
    If Request.ServerVariables("REQUEST_METHOD") = "POST" Then
        ...
        ' And now perform the encryption in a single step.
        ' This is ok with small files/data amounts. For huge data you should
        ' do this in steps encrypting chunks of data one after another - see
        ' the other example in this directory.
        cipher = crypt.Encrypt(infile.ReadBin(infile.Size))
        
        ' And save the cipher into the output file
